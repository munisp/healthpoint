...
const menuItems = [
  ...
  { icon: Scissors, label: "Split-Bill Analysis", path: "/split-bill" },
...
function CommandPaletteButton() {
  ...
  const COMMANDS = [
    ...
    { label: 'Clone Dispute', path: '/disputes/clone', icon: Copy },
    { label: 'Payer Response Times', path: '/payer-response-times', icon: Clock },
    { label: 'Annotations', path: '/annotations', icon: StickyNote },
    { label: 'Batch Evidence Upload', path: '/batch-evidence', icon: Upload },
